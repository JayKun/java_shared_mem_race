class UnsafeMemory {
	...
	try {
	    ...
	    else if (args[0].equals("BetterSafeRW"))
		s = new BetterSafeRW(stateArg, maxval);
	    else if (args[0].equals("SemBetter"))
		s = new SemBetter(stateArg, maxval);
	    else if (args[0].equals("AtomBetter"))
		s = new AtomBetter(stateArg, maxval);
	    else
